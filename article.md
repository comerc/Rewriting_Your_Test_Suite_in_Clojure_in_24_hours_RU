...
Эта история о том как я написал компилятор для автоматической трансляции сценариев тестирования [CircleCI’s](https://circleci.com/) состоящих из 14,000 строк в другую библиотеку тестирования за 24 часа.
